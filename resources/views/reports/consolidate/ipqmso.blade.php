                    ...
                    <div class="card-body">
                        ...
                        @if(isset($pending))
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="pendingFilter" class="mr-2">Pending: </label>
                                        <div class="d-flex">
                                            <select id="pendingFilter" class="custom-select" name="pending">
                                                <option value="0" {{ $pending == 0 ? 'selected' : ''  }} class="quarter">Researcher</option>
                                                <option value="1" {{ $pending == 1 ? 'selected' : ''  }} class="quarter">Extensionist</option>
                                                <option value="2" {{ $pending == 2 ? 'selected' : ''  }} class="quarter">Chairperson</option>
                                                <option value="3" {{ $pending == 3 ? 'selected' : ''  }} class="quarter">Dean</option>
                                                <option value="4" {{ $pending == 4 ? 'selected' : ''  }} class="quarter">Sector</option>
                                                <option value="5" {{ $pending == 5 ? 'selected' : ''  }} class="quarter">IPO</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-hover table-sm table-bordered" id="college_accomplishments_table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="button">
                                                    ...
                                                    <td class="report-view button-view text-center" data-toggle="modal" data-target="#viewReport" data-url="{{ route('document.view', ':filename') }}" data-id="{{ $row->id }}" data-report-category="{{ $row->report_category }}">
                                                        @if (($row->report_category_id >= 12 && $row->report_category_id <= 14) || ($row->report_category_id >= 22 && $row->report_category_id <= 23) || $row->report_category_id == 37)  {{-- Extensionist --}}
                                                        ...
                                                        @if ($row->format == 'a') {{-- Chair/Chief --}}
                                                            @if ($row->report_category_id >= 1 && $row->report_category_id <= 8)
                                                                ...
                                                                @else
                                                                    ...
                                                                    @endif
                                                                @endif
                                                            @elseif (($row->report_category_id >= 12 && $row->report_category_id <= 14) || ($row->report_category_id >= 22 && $row->report_category_id <= 23) || $row->report_category_id == 37)  {{-- Extensionist --}}
                                                                @if ($row->chairperson_approval === null)
                                                                    @if ($row->department_id == $row->college_id)
                                                                        N/A
                                                                    @else
