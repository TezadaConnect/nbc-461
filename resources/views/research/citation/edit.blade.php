<x-app-layout>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class="font-weight-bold mr-2">Edit Citation {{ isset($research['title']) ? 'for '.$research['title'] : '' }}</h3>
                <div class="mb-3">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('research.citation.update', [$research['id'], $values['id']]) }}" enctype="multipart/form-data" method="post" class="needs-validation" novalidate>
                            @csrf
                            @method('put')
