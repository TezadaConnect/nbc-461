    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('research.presentation.update', [$research['id'], $value['id']]) }}" enctype="multipart/form-data" method="post" class="needs-validation" novalidate>
                            @csrf
                            @method('put')
                            ...
                            <div class="col-md-12">
                                <div class="mb-0">
                                    <div class="d-flex justify-content-end align-items-baseline">
                                        <a href="{{ route('research.presentation.index', $research['id']) }}" class="btn btn-secondary mr-2">Cancel</a>
