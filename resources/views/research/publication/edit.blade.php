    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="font-weight-bold mr-2">Edit Publication Details {{ isset($research->title) ? 'of '.$research->title : '' }}</h3>
                        <div class="mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('research.publication.update', [$research['id'], $value['id']]) }}" enctype="multipart/form-data" method="post" class="needs-validation" novalidate>
                            @csrf
                            @method('put')
