                                ...
                                <div class="mb-0">
                                    <div class="d-flex justify-content-end align-items-baseline">
                                        ...
                                        @elseif($research->status == 26)
                                            <button type="button" class="btn btn-sm btn-warning mr-3" style="pointer-events: none;">New Commitment status is not included in the submission but will be reflected on Research Coordinator.</button>
                                        @endif
