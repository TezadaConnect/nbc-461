    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="font-weight-bold mr-2">Edit Copyright Details {{ isset($research->title) ? 'of '.$research->title : '' }}</h3>
                        <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="mb-0">
                                    <div class="d-flex justify-content-end align-items-baseline">
                                        <a href="{{ route('research.copyrighted.index', $research->id) }}" class="btn btn-secondary mr-2">Cancel</a>
