<x-app-layout>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                @section('title', 'Research/Book Chapter Copyright |')
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="font-weight-bold mr-2">Add Copyright Details {{ isset($research['title']) ? 'of '.$research['title'] : '' }}</h3>
                        <div class="mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('research.copyrighted.store', $research->id) }}" enctype="multipart/form-data" method="post" class="needs-validation" novalidate>
                            @csrf
